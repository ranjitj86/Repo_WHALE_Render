...
def export_requirements(format):
    ...
    if format == 'csv':
        ...
        # Temporarily simplify columns for testing
        cols = ['SYS.1 Req. ID', 'SYS.1 System Requirement']
    ...
    try:
        ...
        try:
            ...
            if process_result and process_result.get('status') == 'success':
                 ...
                 return jsonify({
                     'status': 'success',
                     'message': process_result.get('message', 'Agent 3 processing successful!'),
...
def save_sys2_xlsx():
    ...
    try:
        ...
        output_path = os.path.join(output_dir, 'sys2_requirements.xlsx')
